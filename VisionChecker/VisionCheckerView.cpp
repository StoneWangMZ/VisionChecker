...
// VisionCheckerView.cpp : CVisionCheckerView 类的实现
//
...
CVisionCheckerDoc* CVisionCheckerView::GetDocument() const // 非调试版本是内联的
{
